...
export const reelSections: ReelSectionData[] = [
  {
    ...
    variant: "studio",
    eyebrow: "MAXMARK ANIMATIONS — EST. 2024",
    title: "An AI-Native\nProduction Studio",
    strapline:
      "Maxmark Animations creates brand films, narratives, and music visuals with cinematic craft — at African market speed.",
  ...
  },
  {
    ...
    muxPlaybackId: "VCBESmjDlV4eRLTFzQ2j75KtN1XrKyV9sdwaAQXNv38",
    variant: "project",
    eyebrow: "Maxmark Animations Originals",
